...
private:
	...
	vec3 color;
public:
	Cylinder(vec3 cylinderPosition,vec3 cylinderRotation,vec3 cylinderVelocity,float cylinderBase,float cylinderTop,float cylinderLength,float cylinderSize,float m){
		size=cylinderSize;
		mass=m;
		angularVelocity=1;
		...
		baseRadius=cylinderBase;
		topRadius=cylinderTop;
