...
private:
	...
	vec3 color;
public:
	Cone(vec3 conePosition,vec3 coneRotation,vec3 coneVelocity,float coneRadiusBase,float coneRadiusTop,float coneLength,float coneSize,float m){
		size=coneSize;
		mass=m;
		angularVelocity=1;
